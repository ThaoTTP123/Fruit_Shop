...
public class ControllerRegion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ControllerRegion</title>");
            out.println("</head>");
            out.println("<body>");
    ...
    private void display(ResultSet rs, PrintWriter out) {
        ...
        try {
            ...
            Logger.getLogger(ControllerRegion.class.getName()).log(Level.SEVERE, null, ex);
        }
        out.print("</table>");
    }
